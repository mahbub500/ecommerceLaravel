                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        ...
                        <li data-target="#carouselExampleIndicators" data-slide-to="{{ $key }}" @if($key +1 == 1) class="active" @endif>
                            <img width="60" src="{{ asset('storage/products/'.$image->image) }}" alt="" />
                        </li>
                        @endforeach
                    </ol>
            ...
            <div class="s_product_text">
              <form action="{{ url('addtocart/'. $product->slug) }}" method="post" id="addCart" data-type="JSON">
                ...
                <ul class="list">
                    <li>
                      <a class="active" href="#">
                        <span>Category</span> : {{ $product->subcategories()->with('category')->get()->pluck('category')->first()->name }}</a
                      >
                    </li>
                    <li>
                      @if($product->stock > 1)
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="color" id="inlineRadio1" value="{{ $color->name }}" {{ $key == 0 ? 'checked' : '' }}>
                ...
                <div class="card_area">
                  <button class="main_btn" {{ $product->stock == 0 ? 'disabled' : '' }}>Add to Cart</button>
