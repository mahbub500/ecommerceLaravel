                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="name" class="form-control font-20" placeholder="Product Name" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                               <textarea name="feature" class="summernote">{{ old('feature') }}</textarea>
                                @error('features')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="tab-content" id="v-pills-product-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab">
                                        ...
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="discount" class="form-control" placeholder="Product Discount" value="{{ old('discount') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-0 mt-2">
                                            <label for="stockQuantity" class="col-sm-4 col-form-label">Stock</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="stock" class="form-control" placeholder="Product Stock" value="{{ old('stock') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-0">
                                        ...
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-info btn-block">Create Product</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="default-date" name="new_from" class="datepicker-here form-control" value="{{ old('from') }}"/>
                        </div>             
                        <div class="form-group">
                            <label for="">New To</label>
                            <input type="text" id="default-date-to" name="new_to" class="datepicker-here form-control" value="{{ old('to') }}"/>
                        </div>
                    </div>
                </div>
            </div>
